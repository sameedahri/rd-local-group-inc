...
const AcceptedButton: React.FC<AcceptedButtonProps> = ({isAccepted, buttonWidth, buttonHeight}) => {
  return (
    <button 
        type="button" 
        className={`${buttonWidth ? buttonWidth : 'md:w-[128px] w-[86px]'} 
          ${buttonHeight ? buttonHeight : 'md:h-[40px] h-[26px]'}
            ...
            rounded-[10px] border-2 flex justify-center items-center font-gilroyBold md:text-[16px] text-[13px] cursor-default`}
